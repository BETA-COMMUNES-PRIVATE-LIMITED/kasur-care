  ...
  return (
    <div className="bg-gray-50  ">
      <div className="py-10 px-6  md:px-12 lg:px-30">
        ...
        <div className="bg-linear-to-r from-blue-600 to-blue-500 lg:-translate-y-1/2 bottom-30 text-white rounded-2xl px-6 py-8 md:px-10 md:py-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 shadow-lg hover:shadow-xl transition-all duration-300">
          {/* LEFT TEXT */}
