...
const Navbar = () => {
        ...
        <header className='w-full bg-white md:bg-transparent top-0 left-0 right-0'>
            <nav className=' h-24 flex items-center justify-between  bg-white shadow-md'>
                ...
                {/* <div className='xl:hidden block  cursor-pointer'>
                   < RxHamburgerMenu onClick={()=> setIsMenuOpen(!isMenuOpen)} size={30}/> 
                   <div className={`absolute xl:hidden top-24 left-0 w-full bg-white flex flex-col items-center gap-6 font-semibold text-lg transition-all duration-300 ${
 ...
 {isMenuOpen ? (
  ...
  <div
    className={`absolute xl:hidden top-24 left-0 w-full bg-white flex flex-col items-center gap-6 font-semibold text-lg transition-all duration-300 ${
